def linelist(inlines=None,linelab=True,waveunit='micron',vacuum=True):
    ...
    lines_DSNR=Table.read('/Users/annamurphree/Docs/Rupke Research/q3dfit/q3dfit/data/linelists/linelist_DSNR.tbl',format='ipac')
    lines_H2=Table.read('/Users/annamurphree/Docs/Rupke Research/q3dfit/q3dfit/data/linelists/linelist_H2.tbl',format='ipac')
    lines_fine_str=Table.read('/Users/annamurphree/Docs/Rupke Research/q3dfit/q3dfit/data/linelists/linelist_fine_str.tbl',format='ipac')
    lines_TSB=Table.read('/Users/annamurphree/Docs/Rupke Research/q3dfit/q3dfit/data/linelists/linelist_TSB.tbl',format='ipac')
