...
and only the 'WAVE', 'FLUX', 'STDEV' and 'FLAG' entries for IRAS21219m1757_dlw_qst.xdr).
 ...
 :Params:
     ...
     test_sources: in, optional, type=bool
     	True if test sources 4978688_0.ideos.xdr and IRAS21219m1757_dlw_qst.xdr should also be converted to .npy (in addition to the templates)
