...
def qsohostfcn(wave, flux, weight, template_wave, template_flux, index,
                         zstar,ct_coeff, quiet=None, blrpar=None, qsoxdr=None,
    ...
    comps = ymod.eval_components(params=params,wave=wave, qso_model=qsoflux, x=wave)
    continuum = ymod.eval(params,wave=wave, qso_model=qsoflux, x=wave)

    return continuum,comps
