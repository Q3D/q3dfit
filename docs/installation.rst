...
3.9. We recommend installation of clean environment via conda.
    ...
    #. Download one of the supported environment files: `for Python 3.7 <https://github.com/Q3D/q3dfit/blob/main/docs/q3dfit-py37.yml>`_, `for Python 3.8 <https://github.com/Q3D/q3dfit/blob/main/docs/q3dfit-py38.yml>`_, or `for Python 3.9 <https://github.com/Q3D/q3dfit/blob/main/docs/q3dfit-py39.yml>`_. We are currently conducting all primary testing and development in Python 3.8. 
