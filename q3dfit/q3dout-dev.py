...
class q3dout:
    ...
    '''
    def __init__(self, wave, spec, spec_err, col=None, row=None, fitran=None,
                 ct_method='CONTINUUM SUBTRACTED', ct_coeff=None, ct_ebv=None,
                 zstar=None, zstar_err=None, ct_add_poly_weights=None,
                 ct_ppxf_sigma=None, ct_ppxf_sigma_err=None, ct_rchisq=None,
                 cont_dat=None, cont_fit=None, cont_fit_pretweak=None,
                 emlin_dat=None, emlin_fit=None, gd_indx=None,
                 fitran_indx=None, ct_indx=None, noemlinfit=None,
                 noemlinmask=None, redchisq=None, linelist=None,
                 linelabel=None, parinfo=None, maxncomp=None,
                 param=None, perror=None, perror_resid=None, siglim=None, ):
